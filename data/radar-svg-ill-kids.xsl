...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <!--
    modified by Katherine Mentecki from https://github.com/djbpitt/xstuff/blob/master/radar_plot/stooge_radar.xsl
